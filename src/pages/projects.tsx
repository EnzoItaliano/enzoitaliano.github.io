...
import { Card, Col, Container, OverlayTrigger, Placeholder, Row, Tooltip } from 'react-bootstrap'
...
const Projects = () => {
  return (
    <Layout>
        <Container fluid className='text-center py-4' style={{color: "#C0B4A4", backgroundColor: "#363837"}}>
        <h1>Projects</h1>
        <Row>
          <Col className='py-3'>
            <Card className='bg-dark mx-auto border' style={{ width: '20rem', minHeight: '10rem' }}>
              <Card.Body>
                <Card.Title>Numerical Calculation</Card.Title>
                <Card.Subtitle>
                <OverlayTrigger
                  placement="top"
                  overlay={
                ...
                <Card.Text>
                This project consists of translating the codes used in the numerical calculation discipline into the Python language.
                </Card.Text>
                <Card.Link>
                  <Link to="https://github.com/EnzoItaliano/calculoNumericoEmPython" style={{color: "#8F6E47"}}>
                    View repository
                  </Link>
                </Card.Link>
                <Card.Link>
                  <Link to="https://drive.google.com/drive/folders/1bFJjTKkkBAOkTdB8mrAAK3fDP5ekIvG0?usp=share_link" style={{color: "#8F6E47"}}>
          ...
          <Col className='py-3'>
            <Card className='bg-dark mx-auto border' style={{ width: '20rem', minHeight: '10rem' }}>
              <Card.Body>
                <Card.Title>OnService</Card.Title>
                <Card.Subtitle>
                <OverlayTrigger
                  placement="top"
                  overlay={
                ...
                <Card.Text>
                Services marketplace geared toward independent contractors impacted by the COVID-19 pandemic.
                </Card.Text>
                <Card.Text>
                This is just a demo. The real website is not working since June 2022.
                </Card.Text>
                {/* <Card.Link>
                ...
                <Card.Link>
                  <Link to="https://onservicebr.com" style={{color: "#8F6E47"}}>
                    Live demo
                  </Link>
                </Card.Link>
              </Card.Body>
          ...
          <Col className='py-3'>
            <Card className='bg-dark mx-auto border' style={{ width: '20rem', minHeight: '10rem' }}>
              <Card.Body>
                <Card.Title>Cyber Space</Card.Title>
                <Card.Subtitle>
                <OverlayTrigger
                  placement="top"
                  overlay={
                ...
                <OverlayTrigger
                  ...
                  <path d="M104.699 427.387V625.17V650.291V673.152C105.148 673.156 105.598 673.173 106.043 673.214L256.713 687.742C264.606 688.504 270.791 694.856 271.341 702.765L275.986 769.275L407.417 778.653L416.47 717.267C417.644 709.308 424.471 703.41 432.521 703.41H591.483C599.529 703.41 606.356 709.308 607.53 717.267L616.584 778.653L748.018 769.275L752.659 702.765C753.213 694.856 759.394 688.508 767.287 687.742L917.898 673.214C918.344 673.173 918.789 673.156 919.239 673.152V653.542L919.301 653.521V427.387C940.518 400.678 960.608 371.216 976 346.429C952.477 306.384 923.655 270.598 892.848 237.443C864.276 251.825 836.523 268.117 810.311 285.455C797.195 272.417 782.422 261.753 767.911 250.605C753.654 239.154 737.586 230.758 722.347 220.976C726.884 187.188 729.128 153.924 730.031 119.208C690.711 99.4193 648.781 86.2987 606.368 76.8746C589.435 105.334 573.95 136.154 560.463 166.283C544.47 163.611 528.403 162.62 512.314 162.429V162.404C512.202 162.404 512.098 162.429 512.002 162.429C511.902 162.429 511.798 162.404 511.698 162.404V162.429C495.581 162.62 479.525 163.611 463.529 166.283C450.05 136.154 434.573 105.334 417.615 76.8746C375.223 86.2987 333.289 99.4193 293.973 119.208C294.872 153.924 297.116 187.188 301.665 220.976C286.397 230.758 270.35 239.154 256.089 250.605C241.599 261.753 226.801 272.417 213.68 285.455C187.468 268.117 159.724 251.825 131.144 237.443C100.337 270.598 71.5312 306.384 48 346.429C66.4931 375.457 86.3292 404.634 104.699 427.387Z" fill="#478CBF"/>
                  <path d="M784.071 718.723L779.405 785.587C778.843 793.646 772.433 800.061 764.374 800.639L603.884 812.09C603.493 812.12 603.102 812.132 602.715 812.132C594.739 812.132 587.858 806.279 586.68 798.271L577.477 735.856H446.525L437.322 798.271C436.085 806.671 428.576 812.711 420.118 812.09L259.628 800.639C251.569 800.061 245.159 793.646 244.597 785.587L239.931 718.723L104.45 705.661C104.513 720.222 104.7 736.173 104.7 739.349C104.7 882.434 286.211 951.209 511.724 952H511.999H512.278C737.792 951.209 919.24 882.434 919.24 739.349C919.24 736.115 919.435 720.23 919.502 705.661L784.071 718.723Z" fill="#478CBF"/>
                  ...
                  <path d="M656.641 532.537C656.641 565.813 683.602 592.783 716.878 592.783C750.187 592.783 777.148 565.813 777.148 532.537C777.148 499.261 750.187 472.267 716.878 472.267C683.602 472.267 656.641 499.261 656.641 532.537Z" fill="#414042"/>
                  </svg>
                </OverlayTrigger>
                </Card.Subtitle>
                <Card.Text>
                Space shooter game developed using C# and Godot.
                </Card.Text>
                <Card.Link>
                  <Link to="/projects" style={{color: "#8F6E47"}}>
                    View repository
          ...
          <Col className='py-3'>
            <Card className='bg-dark mx-auto border' style={{ width: '20rem', minHeight: '10rem' }}>
              <Card.Body>
                ...
                <Card.Text>
                A Weather API using a service-oriented architecture and connection with OpenWeatherAPI.
                </Card.Text>
                <Card.Link>
                  <Link to="https://github.com/EnzoItaliano/WeatherApp" style={{color: "#8F6E47"}}>
                    View repository
                  </Link>
                </Card.Link>
              </Card.Body>
          ...
          <Col className='py-2'>
            <Card className='bg-dark mx-auto border' style={{ width: '20rem', minHeight: '10rem' }}>
              <Card.Body>
                ...
                <Placeholder as={Card.Link} animation="glow" style={{color: "#8F6E47"}}>
                  <Placeholder xs={5} />
                </Placeholder>
              </Card.Body>
            </Card>
